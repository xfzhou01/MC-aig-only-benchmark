...
def generate_scatter_plot(times1, times2, result_types, solver1_name, solver2_name, output_file):
    ...
    # Add shaded region where solver2 is better (y < x, below diagonal)
    ...
    # Labels
    ax.set_xlabel(f'{solver1_short} CPU Time (s)', fontsize=16, fontweight='bold')
    ax.set_ylabel(f'{solver2_short} CPU Time (s)', fontsize=16, fontweight='bold')
