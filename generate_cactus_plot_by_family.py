...
Usage:
    python generate_cactus_plot_by_family.py --solver dir1 [dir2 ...] --solver dir3 [dir4 ...] --families family1,family2,... [--parser parser_type] [--min-time min_time]
...
def generate_cactus_plot(solver_times_list, solver_names, 
    ...
    for idx, (times, solver_name) in enumerate(zip(solver_times_list, solver_names)):
        ...
        # Simplify solver name with custom labels
        ...
        if 'mab 2025' in solver_short or 'mab 6 add context' in solver_short:
            solver_short = 'rIC3-DynAMic-MAB'
        elif 'dyn 2025' in solver_short or 'sl dynamic' in solver_short:
            solver_short = 'rIC3-DynAMic'
        elif 'ic3 pure' in solver_short:
            solver_short = 'rIC3-Standard'
        elif 'ctg 2025' in solver_short or 'ctg' == solver_short.strip():
            solver_short = 'rIC3-CtgDown'
    ...
    # Set y-axis to start from 400
    ax.set_ylim(400, None)
